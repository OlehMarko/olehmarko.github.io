...
//       fs.writeFile('./storage.json', stringifiedUser, 'utf8', function(err) {
//         if (err) throw 'Error';
...
//         fs.writeFile('./storage.json', stringifiedUsers, 'utf8', function(err) {
//           if (err) throw 'Error';
...
//       }
//       let stringifiedUsers = JSON.stringify(users);
//       fs.writeFile('./storage.json', stringifiedUsers, 'utf8');
